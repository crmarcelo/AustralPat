...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Mantenedor Doctores</title>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Doctores</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="control-group">
								<label class="control-label" for="selectError">Especialidad:</label>
								<div class="controls">
							...
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Ingresar Doctor</button>
