			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
					    <li><a href="ingreso_pacientes.php"><i class="icon-group"></i><span class="hidden-tablet"> Ingreso de Pacientes</span></a></li>	
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Pacientes</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Apellido Materno</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" value="">
								</div>		
							...
							<div class="control-group">
								...
								<div class="controls">
								  <select id="sexo" data-rel="chosen">
							  ...
							  <div class="control-group">
								<label class="control-label" for="selectError">Previsión</label>
								<div class="controls">
								  <select id="fonasa" data-rel="chosen">
									<option>Seleccionar..</option>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="direccion" type="text" value="">
								</div>
							
							<div class="control-group">
							  <label class="control-label" for="typeahead">Ciudad</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='["Puerto Montt","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky","Louisiana","Maine","Maryland","Massachusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Dakota","North Carolina","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]'>
							  </div>
							</div>
							...
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">Ingresar Pacientes</button>
